...
class Demo extends React.Component {
  state = { country: 'br', value: '12345', rawPhone: '',
  ...
  render() {
    return (
      <div style={{fontFamily: "'Montserrat", fontSize: '15px', padding: '10px 25px', margin: '20px auto', maxWidth: '1500px'}}>
		...
		<div>
			<br/><br/>
			<p>In case you want to show only country code in the dropdown, this is the most usable variation of phone component, use the following example</p>
			<PhoneInput
			showOnlyDialCodes
			country={'il'}
			countryCodeEditable={false}
