...
[![npm version](https://img.shields.io/npm/v/react-ui-phone-input.svg?style=flat)](https://www.npmjs.com/package/react-ui-phone-input)
[![npm downloads](https://img.shields.io/npm/dm/react-ui-phone-input.svg?style=flat)](https://www.npmjs.com/package/react-ui-phone-input)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/ofirattia/react-ui-phone-input#contributing)
[![travis build](https://travis-ci.org/ofirattia/react-ui-phone-input.svg?branch=master)](https://travis-ci.org/ofirattia/react-ui-phone-input)

![animation](https://media.giphy.com/media/xiORAWnqoTJDsH0UOI/giphy.gif)

## Installation
```shell-script
npm install react-ui-phone-input --save
```
...
#### [Demo 1 (UI)](https://ofirattia.github.io/react-ui-phone-input.html) - [Demo 2 (CSS)](https://ofirattia.github.io/react-ui-phone-input-css.html)

![screenshot](https://raw.githubusercontent.com/ofirattia/react-ui-phone-input/master/test/screenshot.png)
...
<table>
  ...
  <tr>
    <td> removeDialInput </td>
    <td> false </td>
    <td> remove the country code from the visual input </td>
  </tr>
  <tr>
    <td> showOnlyDialCodes </td>
    <td> false </td>
    <td> show only country code in the dropdown </td>
  </tr>
  <tr>
...
### Contents
- [React Phone Input](#react-phone-input)
	- [Installation](#installation)
	- [Usage](#usage)
			- [Demo 1 (UI) - [Demo 2 (CSS)](https://ofirattia.github.io/react-ui-phone-input-css.html)](#demo-1-ui---demo-2-css)
	- [Options](#options)
		- [Contents](#contents)
		- [Style](#style)
		- [Events](#events)
...
```jsx
import es from 'react-ui-phone-input/lang/es.json'
...
## License
[![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/ofirattia/react-ui-phone-input/blob/master/LICENSE)

Based on [react-phone-input](https://github.com/razagill/react-phone-input) & Based on [react-phone-input-2](https://github.com/bl00mber/react-phone-input-2)
